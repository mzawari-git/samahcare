...
class SeoService
{
    ...
    {
        return [
            'meta_title' => 'سياسة الخصوصية | سماح كير',
            'meta_description' => 'كيفية جمع واستخدام وحماية بياناتك الشخصية في منصة سماح كير.',
            'og_title' => 'سياسة الخصوصية | سماح كير',
            'og_description' => 'سياسة الخصوصية لمنصة سماح كير.',
            'og_image' => asset('images/og-default.jpg'),
            'keywords' => 'خصوصية, حماية البيانات, GDPR',
            'schema_type' => 'WebPage',
        ];
    }
