...
<section class="pt-32 pb-8 bg-gradient-to-b from-brand-50 to-surface text-center">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h1 class="text-3xl font-extrabold text-ink mb-2">طلباتي</h1>
        <p class="text-gray-500">تتبع ومراجعة جميع طلباتك السابقة</p>
    </div>
</section>
            ...
            <div style="background:#fff;border-radius:16px;box-shadow:0 2px 12px rgba(0,0,0,.08);overflow:hidden;">
                <div style="padding:20px 24px;border-bottom:1px solid var(--gray-200);">
                    <h2 style="font-size:1.15rem;margin:0;display:flex;align-items:center;gap:8px;">
                        <i class="fas fa-box" style="color:var(--pink-600);"></i> جميع الطلبات
                    </h2>
                </div>
                <div style="padding:0;">
                    @if($orders->isEmpty())
                    <div style="text-align:center;padding:60px 20px;">
                        ...
                        <p style="font-size:.95rem;color:var(--gray-500);margin-bottom:24px;">لم تقم بطلب أي منتجات بعد. ابدأ بتصفح متجرنا.</p>
                        <a href="{{ route('shop') }}" style="display:inline-flex;align-items:center;gap:8px;padding:12px 32px;background:linear-gradient(135deg,var(--pink-600),var(--pink-500));color:#fff;border:none;border-radius:50px;font-weight:700;font-size:.95rem;text-decoration:none;box-shadow:0 4px 16px rgba(219,39,119,0.2);">تصفح المتجر</a>
                    </div>
                    @else
                        ...
                        <table style="width:100%;border-collapse:collapse;">
                            <thead>
                                <tr style="border-bottom:2px solid var(--gray-100);">
                                    ...
                                    <th style="padding:12px 8px;text-align:right;font-size:.85rem;font-weight:600;color:var(--gray-500);">طريقة الدفع</th>
                            ...
                            <tbody>
                                ...
                                <tr style="border-bottom:1px solid var(--gray-100);">
                                    ...
                                    <td style="padding:12px 8px;font-size:.85rem;color:var(--gray-500);">
