...
<div class="mb-4">
    ...
    <h1 class="h4 mt-2">تعديل كوبون الخصم</h1>
</div>
        ...
        <form action="{{ route('admin.coupons.update', $coupon) }}" method="POST">
            ...
            <div class="row g-3">
                <div class="col-md-4">
                    ...
                    <input type="text" name="code" class="form-control font-monospace" dir="ltr" value="{{ old('code', $coupon->code) }}" required>
                </div>
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                    <label class="form-label">تم الاستخدام</label>
                    <input type="text" class="form-control" value="{{ $coupon->used_count }}" disabled>
                </div>
                <div class="col-12">
                    <div class="form-check">
                        <input type="hidden" name="is_active" value="0">
                        <input type="checkbox" name="is_active" class="form-check-input" value="1" id="is_active" {{ $coupon->is_active ? 'checked' : '' }}>
                        <label class="form-check-label" for="is_active">مفعل</label>
                    </div>
                </div>
                <div class="col-12">
                    <button type="submit" class="btn btn-pink"><i class="fas fa-save"></i> تحديث</button>
                </div>
            </div>
        </form>
    </div>
